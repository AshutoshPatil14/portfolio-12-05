  ...
  return (
    <section id="projects">
      <div className="reveal" ref={addToRefs}>
        <span className="section-kicker"><span className="kicker-num">04 —</span> Projects</span>
      </div>
      <div className="reveal d1" ref={addToRefs}>
        <h2 className="section-heading">Featured<br /><em>Work.</em></h2>
      </div>
        ...
        <div className="proj-row">
          ...
          <div className="proj-info">
            ...
            <div className="proj-features-mini">
              <span className="pfeat">JWT Auth</span><span className="pfeat">User Management</span
              ><span className="pfeat">Responsive UI</span><span className="pfeat">REST API</span
              ><span className="pfeat">Vercel Deploy</span><span className="pfeat">GitHub CI/CD</span>
            </div>
          </div>
          <a href="https://rd-clone-react.vercel.app/" className="proj-link-btn" target="_blank" rel="noopener noreferrer">Live Demo ↗</a>
        </div>
      </div>
    </section>
  )
